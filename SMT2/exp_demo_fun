...
(declare-fun first_name() String)
(declare-fun last_name() String)
(declare-fun email() String)
(declare-fun Gender() String)
(declare-fun Eircode() String)
(declare-fun Area_code() String)
(declare-fun Street_code() String)
(declare-fun IsCatholicPriest() Bool)
