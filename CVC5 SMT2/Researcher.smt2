...
(assert 
    (forall ((o Int)) (=> (isPaper (Oid o))  
        (and 
            ...
            (str.in_re (Paper_name (Oid o)) (re.* (re.union (re.range "A" "Z") (re.range "a" "z"))))
        )
    ))
)
...
(assert 
    (forall ((o Int)) (=> (isResearcher (Oid o))  
        (and 
            ...
            (str.in_re (Researcher_name (Oid o)) (re.* (re.union (re.range "A" "Z") (re.range "a" "z"))))
        )
    ))
)
    ...
    (forall ((o Int)) (=> (isStudent (Oid o))  
        (and 
            (= (str.len (Student_name (Oid o))) 15)  
             (str.in_re (Student_name (Oid o)) (re.* (re.union (re.range "A" "Z") (re.range "a" "z"))))
        )
    ))
)
